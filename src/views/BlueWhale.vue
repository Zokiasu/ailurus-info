...
<template>
  <main>
    <img
      src="https://cdn.midjourney.com/a8995a1b-461c-4ecc-a59d-995013c75f1a/grid_0.png"
      alt=""
    ...
    <div class="relative z-10 flex min-h-screen w-full items-end p-5">
      ...
      >
        ...
        >
          La baleine bleue est le plus grand animal connu sur terre, pouvant
          atteindre des longueurs de plus de 30 mètres et des poids de plus de
          170 tonnes. Elle se nourrit principalement de krill et peut émettre
          des sons très forts pour communiquer avec d'autres baleines à des
