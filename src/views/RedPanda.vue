...
<template>
  <main>
    <img
      src="https://cdn.midjourney.com/af064715-b233-41f6-b1bf-bc51f287efe1/grid_0.png"
      alt=""
    ...
    <div class="relative z-10 flex min-h-screen w-full items-end p-5">
      ...
      >
        ...
        <p class="presentation font-semibold text-3xl md:text-5xl lg:text-7xl text-center lg:text-right md:mt-10 md:mr-10">Le Panda Roux</p>
        <p
        ...
        >
          Le panda roux, également appelé "chat de feu" en raison de sa fourrure
          rousse, est un petit mammifère originaire de l'Himalaya et du
          sud-ouest de la Chine. Bien qu'il ressemble à un petit panda, il n'est
          pas étroitement lié à ce dernier et est plutôt classé dans une famille
          distincte appelée Ailuridae.
        </p>
        <div
      ...
      <div
        ...
        :class="{
          'bottom-52 md:bottom-32 right-8': actualDoc === 0,
